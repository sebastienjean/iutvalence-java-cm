...
public class PileEntiersPositifsOuNulsListeChainee implements PileEntiersPositifsOuNuls
{
	...
	/**
	 * @see fr.iutvalence.java.cm5.interfaces.PileEntiersPositifsOuNuls#empiler(int)
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.interfaces.PileEntiersPositifsOuNuls#depiler()
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.interfaces.PileEntiersPositifsOuNuls#voirSommet()
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.interfaces.PileEntiersPositifsOuNuls#obtenirCapacite()
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.interfaces.PileEntiersPositifsOuNuls#obtenirTaille()
	 */
