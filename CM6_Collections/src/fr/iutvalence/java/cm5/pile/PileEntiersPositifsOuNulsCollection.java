package fr.iutvalence.java.cm5.pile;
		...
		PileEntiersPositifsOuNuls
{
	...
	/**
	 * @see fr.iutvalence.java.cm5.pile.PileEntiersPositifsOuNuls#empiler(int)
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.pile.PileEntiersPositifsOuNuls#depiler()
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.pile.PileEntiersPositifsOuNuls#voirSommet()
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.pile.PileEntiersPositifsOuNuls#obtenirCapacite()
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.pile.PileEntiersPositifsOuNuls#obtenirTaille()
	 */
