...
public class PileListeChainee implements Pile
{
	...
	/**
	 * @see fr.iutvalence.java.cm5.genericite.Pile#empiler(java.lang.Object)
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.genericite.Pile#depiler()
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.genericite.Pile#voirSommet()
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.genericite.Pile#obtenirCapacite()
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.genericite.Pile#obtenirTaille()
	 */
