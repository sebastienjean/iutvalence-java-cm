...
public class PileListeChainee<E> implements Pile<E>
{
	...
	/**
	 * @see fr.iutvalence.java.cm5.parametres.Pile#empiler(java.lang.Object)
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.parametres.Pile#depiler()
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.parametres.Pile#voirSommet()
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.parametres.Pile#obtenirCapacite()
	 */
	...
	/**
	 * @see fr.iutvalence.java.cm5.parametres.Pile#obtenirTaille()
	 */
